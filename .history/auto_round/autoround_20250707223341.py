...
class AutoRound(object):
    ...
    def choose_various_bit(self,block,bit,num_bit,cur_config,default_config,layer_names,current_input_ids,input_others,current_output,mse_loss,device,cache_device):
