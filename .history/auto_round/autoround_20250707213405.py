...
class AutoRound(object):
    ...
    def choose_one_bit(self,block,bit,num_bit,cur_config,default_config,layer_names,current_input_ids,input_others,current_putput,mse_loss,device,cache_device):
        each_loss = {}
        for layer_name in layer_names:
