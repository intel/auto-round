    ...
    def check_needs_auto_gguf_mix_mse(self, block, layer_config, formats, input_ids, input_others, outputs, device,cache_device):
        ...
        for bit_name,cur_config in mix_configs.items():
            for layer_name in layer_names:
                ...
                wrapper_layer.orig_layer
                q_output = self.get_block_outputs(wrapper_layer.orig_layer, current_input_ids, input_others, self.batch_size * self.infer_bs_coeff,
                                        device,
                                        cache_device)
