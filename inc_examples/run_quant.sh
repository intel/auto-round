...
python quantize.py --model /storage/yiliu7/Qwen/Qwen3-30B-A3B-Base/ -t qwen_mxfp4 --use_autoround_format
python quantize.py --model /storage/yiliu7/deepseek-ai/DeepSeek-V2-Lite-Chat -t ds_mxfp4 --use_autoround_format
# python quantize.py --model $model -t qwen_mxfp8 --use_autoround_format
