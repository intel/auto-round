...
class TestUseHpuCompileMode:
    ...
    def test_compile_mode_true(self):
        ...
        with patch('auto_round.utils.device.is_hpu_lazy_mode', return_value=False), \
...
class TestEstimateTuningBlockMem:
    ...
    def test_returns_correct_tuple_length(self):
        ...
        assert len(result) == 4  # layer_memory_dict, layer_activation_memory, block_input_output_memory, additional_memory
