...
# NOTE: q_proj/up_proj (in_features=32) and lm_head (in_features=32) no longer keep
# their plain gguf:q4_k_m / gguf:q6_k config: `_apply_gguf_shape_fallback` (merged from
# main's #1960, "fix few bugs cause less accuracy of gguf format") falls each layer back
# to the largest gguf type whose block_size (32 / 32) evenly divides in_features=32 —
# gguf:q5_0 for the K-quant body layers, gguf:q8_0 for the K-quant lm_head — since
# gguf:q4_k_m / gguf:q6_k both require block_size=256. Rebaselined post-merge
# (2026-07-08); see docs/behavior-changes/decouple-scheme-format-layer-config.md.
