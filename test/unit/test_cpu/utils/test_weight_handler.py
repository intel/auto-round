...
class TestDetectWeightType:
    ...
    def test_module_with_quantized_weight_type_attribute(self):
        ...
        from auto_round.utils.weight_handler import ModuleWeightType, detect_weight_type
...
class TestIsQuantizedInputModule:
    ...
    def test_model_with_quantized_weight_type_attribute(self):
        ...
        from auto_round.utils.weight_handler import ModuleWeightType, is_quantized_input_module
...
class TestGetHandler:
    ...
    def test_fp8_handler_exists(self):
        ...
        from auto_round.utils.weight_handler import ModuleWeightType, get_handler
...
class TestGetAllHandlers:
    ...
    def test_all_registered_handlers_returned(self):
        ...
        from auto_round.utils.weight_handler import ModuleWeightType, get_all_handlers
...
class TestRegisterWeightTypeHandler:
    ...
    def test_decorator_requires_weighttypehandler_subclass(self):
        ...
        from auto_round.utils.weight_handler import ModuleWeightType, WeightTypeHandler, register_weight_type_handler
