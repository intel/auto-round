...
from auto_round.algorithms.transforms.rotation.utils.matrix import (
    apply_transform_weight,
    multihead_matmul,
)
from auto_round.algorithms.transforms.rotation.dispatcher import (
...
class TestRotationConfigValidation:
    ...
    def test_quarot_hadamard_type(self):
        cfg = RotationConfig(hadamard_type="quarot_hadamard")
