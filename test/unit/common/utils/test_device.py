...
# ===========================================================================
# Additional coverage (previously test_device.py) -- see individual class
...
class TestMemoryMonitor:
    ...
    def test_update_cpu_disabled_noop(self):
        """When disabled, update_cpu() must not change peak_ram (MemoryMonitor is a
        module-level singleton, so this compares before/after rather than assuming
        a fresh baseline of 0.0 -- other tests in this class may have already
        advanced its state)."""
        from auto_round.utils.device import MemoryMonitor
