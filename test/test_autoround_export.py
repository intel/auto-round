...
class TestAutoroundExport(unittest.TestCase):
    ...
    def test_autoround_int_quant(self):
        ...
        from auto_round.export.export_to_itrex import _pack_model
        compressed_model = _pack_model(model=q_model, weight_config=weight_config1)
        ...
        compressed_model = _pack_model(model=q_model, weight_config=weight_config2, inplace=False)
