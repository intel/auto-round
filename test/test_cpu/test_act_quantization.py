...
class TestAutoRoundAct:
    ...
    def test_mx_fp4(self, tiny_model, tokenizer, dataloader):
    ...
    def test_wint4fp8_dynamic(self, tiny_model, tokenizer, dataloader):
    ...
    def test_wint4fp8_static(self, tiny_model, tokenizer, dataloader):
        bits, group_size, sym = 4, 128, True
        autoround = AutoRound(
            tiny_model,
            tokenizer,
    ...
    def test_wfp8afp8_static(self, act_group_size, tiny_model, tokenizer, dataloader):
    ...
    def test_act_config_MXFP4_saving(self, tiny_model_path, dataloader):
        scheme = "MXFP4"
    ...
    def test_act_config_NVFP4_saving(self, tiny_model_path, dataloader):
        scheme = "NVFP4"
    ...
    def test_WOQ_config_INT_saving(self, tiny_model_path, dataloader):
        scheme = "W4A16"
    ...
    def test_act_config_FP8_saving(self, tiny_model_path, dataloader):
        scheme = "FP8_STATIC"
        layer_config = {
