...
class TestGetFpLayerNames:
    ...
    def test_regular_linear_layers(self):
        ...
        class MockModel(torch.nn.Module):
            def __init__(self):
                ...
                self.mlp = torch.nn.Sequential(torch.nn.Linear(10, 10), torch.nn.Linear(10, 10))
    ...
    def test_none_ignore_layers(self):
        """Test with None as ignore_layers input."""
        ...
        model = MockModel()
        result = get_fp_layer_names(model, None)
        assert len(result) == 0, "None ignore_layers should return empty list"
        ...
        class MockModel(torch.nn.Module):
            def __init__(self):
                ...
                self.layers = torch.nn.ModuleList(
                    [torch.nn.Linear(10, 10), torch.nn.Linear(10, 10), torch.nn.Linear(10, 10)]
                )
