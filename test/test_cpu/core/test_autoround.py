...
class TestAutoRound:
    ...
    def test_dequant_g2_fp8_weight(self):
        """Test Gaudi2-specific dequantization redirection logic in convert_model_to_high_precision_if_necessary."""
        from unittest.mock import MagicMock, patch

        from auto_round.utils.model import convert_model_to_high_precision_if_necessary, dequant_block_fp8_weight
        ...
        # Test 2: Verify Gaudi2 redirection in convert_model_to_high_precision_if_necessary
        ...
        with patch("auto_round.utils.device.is_gaudi2", return_value=True):
            convert_model_to_high_precision_if_necessary(mock_layer, device="hpu")
