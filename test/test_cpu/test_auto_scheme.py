...
class TestAutoScheme:
    ...
    def test_auto_scheme_export(self, tiny_model_path):
    ...
    def test_layer_config(self, tiny_model_path):
        ...
        self.assertEqual(layer_config["model.decoder.layers.1.fc1"]["bits"], 8)
        self.assertEqual(layer_config["model.decoder.layers.1.fc1"]["sym"], False)
        self.assertEqual(layer_config["model.decoder.layers.1.fc1"]["group_size"], 32)
