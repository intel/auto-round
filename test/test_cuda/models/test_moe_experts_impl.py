...
"""
Test script for moe_experts_impl.py - linear_loop experts implementation.
...
def test_unfuse_experts_weights():
    ...
    from auto_round.modelling.moe_experts_impl import _unfuse_experts_weights_inplace
...
if __name__ == "__main__":
    print("Testing moe_experts_impl.py...\n")
...
def test_deepseek_v2_with_linear_loop(tiny_deepseek_v2_model_path, dataloader):
    ...
    from auto_round.modelling.moe_experts_impl import is_linear_loop_available
