...
class TestAutoScheme(unittest.TestCase):
    ...
    def test_shared_layers(self):
        ...
        shared_layers = [["*.self_attn.k_proj", "v_proj", "q_proj", "out_proj"],
                        ("model.decoder.layers.6.fc1", "model.decoder.layers.6.fc2"), ("fc1", "fc2")]
        ...
        assert ['model.decoder.layers.2.self_attn.out_proj', 'model.decoder.layers.2.self_attn.q_proj',
                'model.decoder.layers.2.self_attn.v_proj'] in res
