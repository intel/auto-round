...
int launch_prefill_kernel_f16_128_sage_i4pv(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_i4pv_long<cute::int8_t, cute::int8_t, cute::int4_t, cute::half_t, true,
                                                    true, true>(options);
  }
  return launch_sage_prefill_kernel_128<cute::int8_t, cute::int8_t, cute::int4_t, cute::half_t, true, true, true>(
      options);
}

int launch_prefill_kernel_f16_128_sage_s4(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_int4qk_long<cute::int4_t, cute::int4_t, cute::int4_t, cute::half_t, true,
                                                      true, true>(options);
  }
  return launch_sage_prefill_kernel_128_int4qk<cute::int4_t, cute::int4_t, cute::int4_t, cute::half_t, true, true,
                                              true>(options);
}

int launch_prefill_kernel_f16_128_sage_s4_i8pv(detail::Options const& options) {
  return launch_sage_prefill_kernel_128_int4qk_i8pv<cute::int4_t, cute::int4_t, cute::int8_t, cute::half_t, true,
                                                    true, true>(options);
}

int launch_prefill_kernel_f16_128_sage_s4_pv_no_writeback(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_int4qk_long<cute::int4_t, cute::int4_t, cute::int4_t, cute::half_t, true,
                                                      false, true>(options);
  }
  return launch_sage_prefill_kernel_128_int4qk<cute::int4_t, cute::int4_t, cute::int4_t, cute::half_t, true, false,
                                               true>(options);
}

int launch_prefill_kernel_f16_128_sage_s4_no_pv_execute(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_int4qk_long<cute::int4_t, cute::int4_t, cute::int4_t, cute::half_t, true,
                                                      false, false>(options);
  }
...
int launch_prefill_kernel_f16_64_sage_i4pv(detail::Options const& options) {
  return launch_sage_prefill_kernel_64<cute::int8_t, cute::int8_t, cute::int4_t, cute::half_t, true, true, true>(
      options);
}

int launch_prefill_kernel_f16_64_sage_s4(detail::Options const& options) {
  return launch_sage_prefill_kernel_64_int4qk<cute::int4_t, cute::int4_t, cute::int4_t, cute::half_t, true, true,
                                             true>(options);
}

int launch_prefill_kernel_f16_64_sage_s4_i8pv(detail::Options const& options) {
  return launch_sage_prefill_kernel_64_int4qk_i8pv<cute::int4_t, cute::int4_t, cute::int8_t, cute::half_t, true, true,
                                                  true>(options);
}
...
int launch_prefill_kernel_bf16_128_sage_i4pv(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_i4pv_long<cute::int8_t, cute::int8_t, cute::int4_t, cute::bfloat16_t, true,
                                                    true, true>(options);
  }
  return launch_sage_prefill_kernel_128<cute::int8_t, cute::int8_t, cute::int4_t, cute::bfloat16_t, true, true,
                                        true>(options);
}

int launch_prefill_kernel_bf16_128_sage_s4(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_int4qk_long<cute::int4_t, cute::int4_t, cute::int4_t, cute::bfloat16_t, true,
                                                      true, true>(options);
  }
  return launch_sage_prefill_kernel_128_int4qk<cute::int4_t, cute::int4_t, cute::int4_t, cute::bfloat16_t, true, true,
                                              true>(options);
}

int launch_prefill_kernel_bf16_128_sage_s4_i8pv(detail::Options const& options) {
  return launch_sage_prefill_kernel_128_int4qk_i8pv<cute::int4_t, cute::int4_t, cute::int8_t, cute::bfloat16_t, true,
                                                    true, true>(options);
}

int launch_prefill_kernel_bf16_128_sage_s4_pv_no_writeback(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_int4qk_long<cute::int4_t, cute::int4_t, cute::int4_t, cute::bfloat16_t, true,
                                                      false, true>(options);
  }
  return launch_sage_prefill_kernel_128_int4qk<cute::int4_t, cute::int4_t, cute::int4_t, cute::bfloat16_t, true,
                                               false, true>(options);
}

int launch_prefill_kernel_bf16_128_sage_s4_no_pv_execute(detail::Options const& options) {
  if (options.seq_len_qo >= 16384 && options.seq_len_kv >= 16384) {
    return launch_sage_prefill_kernel_128_int4qk_long<cute::int4_t, cute::int4_t, cute::int4_t, cute::bfloat16_t, true,
                                                      false, false>(options);
  }
...
int launch_prefill_kernel_bf16_64_sage_i4pv(detail::Options const& options) {
  return launch_sage_prefill_kernel_64<cute::int8_t, cute::int8_t, cute::int4_t, cute::bfloat16_t, true, true,
                                       true>(options);
}

int launch_prefill_kernel_bf16_64_sage_s4(detail::Options const& options) {
  return launch_sage_prefill_kernel_64_int4qk<cute::int4_t, cute::int4_t, cute::int4_t, cute::bfloat16_t, true, true,
                                             true>(options);
}

int launch_prefill_kernel_bf16_64_sage_s4_i8pv(detail::Options const& options) {
  return launch_sage_prefill_kernel_64_int4qk_i8pv<cute::int4_t, cute::int4_t, cute::int8_t, cute::bfloat16_t, true,
                                                  true, true>(options);
}

KernelLauncher select_sage_prefill_launcher(BTLA_DTYPE dtype, BTLA_DTYPE pv_dtype, BTLA_DTYPE quantized_v_dtype,
                                            int head_dim, bool use_quantized_pv) {
  switch (dtype) {
    case BTLA_DTYPE::S8:
      switch (head_dim) {
        case 128:
          if (use_quantized_pv) {
            if (quantized_v_dtype == BTLA_DTYPE::S4) {
              if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_128_sage_i4pv;
              return launch_prefill_kernel_f16_128_sage_i4pv;
            }
        ...
        case 64:
          if (use_quantized_pv) {
            if (quantized_v_dtype == BTLA_DTYPE::S4) {
              if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_64_sage_i4pv;
              return launch_prefill_kernel_f16_64_sage_i4pv;
            }
    ...
    case BTLA_DTYPE::S4:
      if (!use_quantized_pv || (quantized_v_dtype != BTLA_DTYPE::S4 && quantized_v_dtype != BTLA_DTYPE::S8)) {
        return nullptr;
      }
      switch (head_dim) {
        case 128:
          if (quantized_v_dtype == BTLA_DTYPE::S8) {
            if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_128_sage_s4_i8pv;
            return launch_prefill_kernel_f16_128_sage_s4_i8pv;
          }
          if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_128_sage_s4;
          return launch_prefill_kernel_f16_128_sage_s4;
        case 64:
          if (quantized_v_dtype == BTLA_DTYPE::S8) {
            if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_64_sage_s4_i8pv;
            return launch_prefill_kernel_f16_64_sage_s4_i8pv;
          }
...
KernelLauncher select_sage_int4_diag_prefill_launcher(BTLA_DTYPE pv_dtype, int head_dim, bool execute_pv) {
  if (head_dim != 128) return nullptr;
  if (execute_pv) {
    if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_128_sage_s4_pv_no_writeback;
    return launch_prefill_kernel_f16_128_sage_s4_pv_no_writeback;
  }
  if (pv_dtype == BTLA_DTYPE::BF16) return launch_prefill_kernel_bf16_128_sage_s4_no_pv_execute;
  return launch_prefill_kernel_f16_128_sage_s4_no_pv_execute;
}
...
void sage_prefill(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
                  int scale_block_size, void* qscale, void* kscale, void* vscale, bool use_quantized_pv,
                  BTLA_DTYPE q_dtype, BTLA_DTYPE pv_dtype, BTLA_DTYPE quantized_v_dtype, int q_stride_s,
                  int q_stride_d, int q_stride_h, int q_stride_b, int k_stride_s, int k_stride_d, int k_stride_h,
                  int k_stride_b, int v_stride_d, int v_stride_s, int v_stride_h, int v_stride_b, int o_stride_s,
                  int o_stride_d, int o_stride_h, int o_stride_b, int batch, int num_heads_q, int num_heads_kv,
                  int seq_len_q, int seq_len_kv, int head_dim, float softmax_scale, bool is_causal,
                  float* lse = nullptr, int vscale_stride_d = 1) {
  detail::Options options =
  ...
  options.vscale_stride_d = vscale_stride_d;
  options.lse = lse;
  compat::set_default_queue(*q);

  KernelLauncher launcher =
      select_sage_prefill_launcher(q_dtype, pv_dtype, quantized_v_dtype, head_dim, use_quantized_pv);
  if (launcher == nullptr) {
    throw std::runtime_error(
        "Unsupported dtype or head dimension for sage_prefill / SAGE "
        "(only S8/S4 QK and F16/BF16 output with 64/128 head_dim are supported)");
  }

  launcher(options);
}

void sage_int4_diag_prefill(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
                            ...
                            float* lse = nullptr, int vscale_stride_d = 1, bool execute_pv = true) {
  detail::Options options =
      make_common_options(Q_ptr, K_ptr, V_ptr, O_ptr, mask, q_stride_s, q_stride_d, q_stride_h, q_stride_b,
                          k_stride_s, k_stride_d, k_stride_h, k_stride_b, v_stride_d, v_stride_s, v_stride_h,
                          v_stride_b, o_stride_s, o_stride_d, o_stride_h, o_stride_b, batch, num_heads_q,
  ...
  KernelLauncher launcher = select_sage_int4_diag_prefill_launcher(o_dtype, head_dim, execute_pv);
  if (launcher == nullptr) {
    throw std::runtime_error(
        "Unsupported dtype or head dimension for sage_int4 diagnostic prefill "
        "(only packed S4 Q/K/V, F16/BF16 output, head_dim=128)");
  }
...
void sdpa_impl_qks8_pvhalf(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
  ...
  sage_prefill(q, Q_ptr, K_ptr, V_ptr, O_ptr, mask, scale_block_size, qscale, kscale, nullptr, false,
               BTLA_DTYPE::S8, pv_dtype, BTLA_DTYPE::EleBitsUndef, q_stride_s, q_stride_d, q_stride_h, q_stride_b,
...
void sdpa_impl_qks8_pvi8(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
  ...
  sage_prefill(q, Q_ptr, K_ptr, V_ptr, O_ptr, mask, scale_block_size, qscale, kscale, vscale, true,
               BTLA_DTYPE::S8, o_dtype, BTLA_DTYPE::S8, q_stride_s, q_stride_d, q_stride_h, q_stride_b, k_stride_s,
               ...
               head_dim, softmax_scale, is_causal, lse, vscale_stride_d);
}

void sdpa_impl_qks8_pvi4(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
                         int scale_block_size, void* qscale, void* kscale, void* vscale, int q_stride_s,
                         int q_stride_d, int q_stride_h, int q_stride_b, int k_stride_s, int k_stride_d,
                         int k_stride_h, int k_stride_b, int v_stride_d, int v_stride_s, int v_stride_h,
                         int v_stride_b, int o_stride_s, int o_stride_d, int o_stride_h, int o_stride_b,
                         ...
                         float* lse = nullptr, int vscale_stride_d = 1) {
  if (mask && is_causal) {
    throw std::invalid_argument("sdpa_impl_qks8_pvi4: mask and is_causal cannot both be set");
  }
  if (seq_len_q <= 1 || seq_len_kv <= 0) {
    throw std::invalid_argument("sdpa_impl_qks8_pvi4: only prefill with seq_len_q > 1 is supported");
  }
  if (vscale == nullptr) {
    throw std::invalid_argument("sdpa_impl_qks8_pvi4: vscale must be provided for int4 PV");
  }
  if (o_dtype != BTLA_DTYPE::F16 && o_dtype != BTLA_DTYPE::BF16) {
    throw std::invalid_argument("sdpa_impl_qks8_pvi4: only F16 and BF16 are supported for output dtype");
  }
  if (head_dim != 64 && head_dim != 128) {
    throw std::invalid_argument("sdpa_impl_qks8_pvi4: head_dim must be 64 or 128");
  }

  sage_prefill(q, Q_ptr, K_ptr, V_ptr, O_ptr, mask, scale_block_size, qscale, kscale, vscale, true,
               BTLA_DTYPE::S8, o_dtype, BTLA_DTYPE::S4, q_stride_s, q_stride_d, q_stride_h, q_stride_b,
               k_stride_s, k_stride_d, k_stride_h, k_stride_b, v_stride_d, v_stride_s, v_stride_h, v_stride_b,
               o_stride_s, o_stride_d, o_stride_h, o_stride_b, batch, num_heads_q, num_heads_kv, seq_len_q,
               seq_len_kv, head_dim, softmax_scale, is_causal, lse, vscale_stride_d);
}

void sdpa_impl_qks4_pvi4(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
                         int scale_block_size, void* qscale, void* kscale, void* vscale, int q_stride_s,
                         int q_stride_d, int q_stride_h, int q_stride_b, int k_stride_s, int k_stride_d,
                         int k_stride_h, int k_stride_b, int v_stride_d, int v_stride_s, int v_stride_h,
                         int v_stride_b, int o_stride_s, int o_stride_d, int o_stride_h, int o_stride_b,
                         ...
                         float* lse = nullptr, int vscale_stride_d = 1) {
  if (mask && is_causal) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4: mask and is_causal cannot both be set");
  }
  if (seq_len_q <= 1 || seq_len_kv <= 0) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4: only prefill with seq_len_q > 1 is supported");
  }
  if (qscale == nullptr || kscale == nullptr || vscale == nullptr) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4: qscale, kscale and vscale must be provided");
  }
  if (o_dtype != BTLA_DTYPE::F16 && o_dtype != BTLA_DTYPE::BF16) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4: only F16 and BF16 are supported for output dtype");
  }
  if (head_dim != 64 && head_dim != 128) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4: head_dim must be 64 or 128");
  }

  sage_prefill(q, Q_ptr, K_ptr, V_ptr, O_ptr, mask, scale_block_size, qscale, kscale, vscale, true,
               BTLA_DTYPE::S4, o_dtype, BTLA_DTYPE::S4, q_stride_s, q_stride_d, q_stride_h, q_stride_b,
               k_stride_s, k_stride_d, k_stride_h, k_stride_b, v_stride_d, v_stride_s, v_stride_h, v_stride_b,
               o_stride_s, o_stride_d, o_stride_h, o_stride_b, batch, num_heads_q, num_heads_kv, seq_len_q,
               seq_len_kv, head_dim, softmax_scale, is_causal, lse, vscale_stride_d);
}

void sdpa_impl_qks4_pvi8(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
                         int scale_block_size, void* qscale, void* kscale, void* vscale, int q_stride_s,
                         int q_stride_d, int q_stride_h, int q_stride_b, int k_stride_s, int k_stride_d,
                         int k_stride_h, int k_stride_b, int v_stride_d, int v_stride_s, int v_stride_h,
                         int v_stride_b, int o_stride_s, int o_stride_d, int o_stride_h, int o_stride_b,
                         ...
                         float* lse = nullptr, int vscale_stride_d = 1) {
  if (mask && is_causal) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi8: mask and is_causal cannot both be set");
  }
  if (seq_len_q <= 1 || seq_len_kv <= 0) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi8: only prefill with seq_len_q > 1 is supported");
  }
  if (qscale == nullptr || kscale == nullptr || vscale == nullptr) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi8: qscale, kscale and vscale must be provided");
  }
  if (o_dtype != BTLA_DTYPE::F16 && o_dtype != BTLA_DTYPE::BF16) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi8: only F16 and BF16 are supported for output dtype");
  }
  if (head_dim != 64 && head_dim != 128) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi8: head_dim must be 64 or 128");
  }

  sage_prefill(q, Q_ptr, K_ptr, V_ptr, O_ptr, mask, scale_block_size, qscale, kscale, vscale, true,
               BTLA_DTYPE::S4, o_dtype, BTLA_DTYPE::S8, q_stride_s, q_stride_d, q_stride_h, q_stride_b,
               k_stride_s, k_stride_d, k_stride_h, k_stride_b, v_stride_d, v_stride_s, v_stride_h, v_stride_b,
               o_stride_s, o_stride_d, o_stride_h, o_stride_b, batch, num_heads_q, num_heads_kv, seq_len_q,
               seq_len_kv, head_dim, softmax_scale, is_causal, lse, vscale_stride_d);
}

void sdpa_impl_qks4_pvi4_diag(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
                              int scale_block_size, void* qscale, void* kscale, void* vscale, int q_stride_s,
                              int q_stride_d, int q_stride_h, int q_stride_b, int k_stride_s, int k_stride_d,
                              int k_stride_h, int k_stride_b, int v_stride_d, int v_stride_s, int v_stride_h,
                              int v_stride_b, int o_stride_s, int o_stride_d, int o_stride_h, int o_stride_b,
                              ...
                              float* lse = nullptr, int vscale_stride_d = 1, bool execute_pv = true) {
  if (mask && is_causal) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4_diag: mask and is_causal cannot both be set");
  }
  if (seq_len_q <= 1 || seq_len_kv <= 0) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4_diag: only prefill with seq_len_q > 1 is supported");
  }
  if (qscale == nullptr || kscale == nullptr || vscale == nullptr) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4_diag: qscale, kscale and vscale must be provided");
  }
  if (o_dtype != BTLA_DTYPE::F16 && o_dtype != BTLA_DTYPE::BF16) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4_diag: only F16 and BF16 are supported for output dtype");
  }
  if (head_dim != 128) {
    throw std::invalid_argument("sdpa_impl_qks4_pvi4_diag: head_dim must be 128");
  }

  sage_int4_diag_prefill(q, Q_ptr, K_ptr, V_ptr, O_ptr, mask, scale_block_size, qscale, kscale, vscale, q_stride_s,
                         ...
                         softmax_scale, is_causal, o_dtype, lse, vscale_stride_d, execute_pv);
}
...
void sage_prefill_varlen(sycl::queue* q, void* Q_ptr, void* K_ptr, void* V_ptr, void* O_ptr, void* mask,
  ...
  KernelLauncher launcher =
      select_sage_prefill_launcher(q_dtype, pv_dtype, use_int8_pv ? BTLA_DTYPE::S8 : BTLA_DTYPE::EleBitsUndef,
