...
- `SPARSE_SAGE_KERNEL_STATUS.md`: current development status of the ARK sparse Sage kernel, including what is validated and what is still missing before full Sparge integration.
