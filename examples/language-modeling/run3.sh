...
device=5
eval_bs=16
for model_name in "/models/Meta-Llama-3-8B-Instruct" "/models/Qwen2-7B" "/data5/models/Phi-3-mini-4k-instruct/"  "/models/Mistral-7B-Instruct-v0.2" "/models/Llama-2-7b-hf-no-t"
do
...
#  --output_dir "/data5/wenhuach/test_mxfp4_no0.5-disable-minmaxlr" \
#  2>&1 | tee -a tmp_mxpf4_disabel_minmax_tuning.txt
#done
#
#for model_name in "/models/gpt-j-6B" "/models/Llama-2-7b-hf-no-t" "/models/Qwen2-7B"  "/models/opt-2.7b" "/models/mpt-7b" "/models/Meta-Llama-3-8B-Instruct" "/models/dolly-v2-3b" "/models/Mistral-7B-Instruct-v0.2" "/data5/models/Phi-3-mini-4k-instruct/"
#do
#  CUDA_VISIBLE_DEVICES=$device \
#  python3 main.py \
#  --model_name  $model_name \
...
#  --eval_bs $eval_bs \
#  --disable_low_gpu_mem_usage \
#  --output_dir "/data5/wenhuach/test_mxfp4_no0.5-lr1e-2minmaxlr1e-2" \
#  2>&1 | tee -a tmp_mxpf4-lr1e-2minmaxlr1e-2.txt
#done

#for model_name in "/models/opt-125m" "/models/Llama-2-7b-hf-no-t" "/models/Meta-Llama-3-8B-Instruct"
#do
#  CUDA_VISIBLE_DEVICES=$device \
#  python3 main.py \
#  --model_name  $model_name \
...
#  --enable_lora \
#  --eval_bs $eval_bs \
#  --output_dir "/data5/wenhuach/low_rank_w2g32" \
#  2>&1 | tee -a low_rank_w2g32.txt
#done
...
#  --eval_bs $eval_bs \
#  --disable_tuning \
#  --output_dir "/data5/wenhuach/tmp2_disable_tuning" \
...
#--disable_low_gpu_mem_usage \
#--output_dir "/data5/wenhuach/Qwen2-0.5B-instruct-W4G32sym-iter1000-seqlen4096" \
#2>&1 | tee -a tmp.txt
...
#--deployment_device 'gpu,fake' \
#--disable_low_gpu_mem_usage \
#--output_dir "/data5/wenhuach/Qwen2-1.5B-instruct-W4G32sym-iter1000-seqlen4096" \
#2>&1 | tee -a tmp.txt
...
#--iters 1000 \
#--disable_eval \
#--dataset "madao33/new-title-chinese,NeelNanda/pile-10k" \
#--deployment_device 'autoround,fake' \
#--disable_low_gpu_mem_usage \
#--output_dir "/data5/wenhuach/Qwen2-7B-W4G128asym-iter1000-ar-mixed" \
#2>&1 | tee -a tmp.txt
