...
#for model_name in "/models/Meta-Llama-3-8B-Instruct" "/models/Mistral-7B-Instruct-v0.2" "/data5/models/Phi-3-mini-4k-instruct/"
#do
...
for model_name in  "/models/Meta-Llama-3-8B-Instruct" "/models/Mistral-7B-Instruct-v0.2"
do
  CUDA_VISIBLE_DEVICES=$device \
  python3 main.py \
  --model_name  $model_name \
  ...
  --eval_bs $eval_bs \
  --output_dir "/data5/wenhuach/test_seqlen512" \
  2>&1 | tee -a test_seqlen512_1.txt
done
...
#  --deployment_device 'auto_round' \
#  --eval_bs $eval_bs \
#  --output_dir "/data5/wenhuach/test_fast_config_w2g32" \
#  2>&1 | tee -a test_w2g32_fast_config.txt
#done
#
#
#for model_name in  "/models/Meta-Llama-3-8B-Instruct" "/models/Qwen2-7B-Instruct"  "/models/Mistral-7B-Instruct-v0.2" "/models/Phi-3-mini-4k-instruct/"
...
#  --deployment_device 'auto_round' \
#  --eval_bs $eval_bs \
#  --output_dir "/data5/wenhuach/test_disable_fast_config_w2g32" \
#  2>&1 | tee -a test_w2g32_disable_fast_quant.txt
#done
...
#  2>&1 | tee -a test_rtn_eq_ratio_0.05_no_absorb_ln.txt
#done
...
#  --eval_bs $eval_bs \
#  --disable_low_gpu_mem_usage \
#  --output_dir "/data5/wenhuach/test_mx_absorb_ln" \
#  2>&1 | tee -a test_mx_fp4_absrob_ln_wa_iter200.txt
#done
...
#  --eval_bs $eval_bs \
#  --disable_low_gpu_mem_usage \
#  --output_dir "/data5/wenhuach/test_mxfp4_no0.5-round-inner-minmaxlr-1e-2" \
#  2>&1 | tee -a tmp_mxpf4.txt
#done

#model_name="/models/dolly-v2-3b"
#CUDA_VISIBLE_DEVICES=$device \
#python3 main.py \
#--model_name  $model_name \
#--device 0 \
...
#--eval_bs $eval_bs \
#--disable_low_gpu_mem_usage \
#--output_dir "/data5/wenhuach/test_mxfp4-minmaxlr1e-2" \
#2>&1 | tee -a tmp_minmax_1e-2.txt
...
#--eval_bs $eval_bs \
#--disable_low_gpu_mem_usage \
#--output_dir "/data5/wenhuach/test_mxfp4" \
#2>&1 | tee -a tmp.txt
...
#--disable_low_gpu_mem_usage \
#--disable_eval \
#--output_dir "/data5/wenhuach/Qwen2-7B-Instruct-iter200-lmhead" \
#2>&1 | tee -a tmp.txt
