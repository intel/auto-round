...
class WapperResBlock(BaseWrapperBlock, TimestepBlock):
    def __init__(
...
class WapperQKMatMul(BaseWrapperBlock):
    def __init__(
...
class WapperSMVMatMul(BaseWrapperBlock):
    def __init__(
...
class WapperAttentionBlock(BaseWrapperBlock):
    def __init__(
...
class WapperBasicTransformerBlock(BaseWrapperBlock):
    def __init__(
...
class WapperResnetBlock(BaseWrapperBlock):
    def __init__(
...
class WapperAttnBlock(BaseWrapperBlock):
    def __init__(
...
def get_specials(quant_act=False):
    specials = {
        ResBlock: WapperResBlock,
        BasicTransformerBlock: WapperBasicTransformerBlock,
        ResnetBlock: WapperResnetBlock,
        AttnBlock: WapperAttnBlock,
    }
    if quant_act:
        specials[QKMatMul] = WapperQKMatMul
        specials[SMVMatMul] = WapperSMVMatMul
    else:
        specials[AttentionBlock] = WapperAttentionBlock
    return specials