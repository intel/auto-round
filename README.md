...
## 🆕 What's New
* [2026/08] AWQ can now be composed with AutoRound (`--algorithm awq,auto_round`) for activation-aware smoothing before AutoRound optimization. See [AWQ algorithm results](./docs/awq_details.md) for details.
