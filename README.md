...
**CPU**: pip install intel-extension-for-pytorch(much higher speed, potential accuracy drop) or pip install intel-extension-for-transformers, auto_round version >0.3.1
