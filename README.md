...
## 🆕 What's New
* [2025/12] [AutoRoundV2 paper](http://arxiv.org/abs/2512.04746) is public at arxiv, please use `AutoScheme` API for mixed precision quantization and use 'enable_alg_ext' to reproduce the results.
* 
