...
## 🆕 What's New
* [2026/08] We experimentally support **algorithm composition**, e.g., AWQ + SignRound (`--algorithm awq,signround`, [./docs/awq_details.md](./docs/awq_details.md)) and Hadamard (research feature) + AWQ + SignRound (`--algorithm hadamard,awq,signround`, [./docs/rotation_details.md](./docs/rotation_details.md)), to improve accuracy, especially in scenarios with activation quantization.
