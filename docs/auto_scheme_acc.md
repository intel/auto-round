...
### GGUF model evaluation results

**Unless explicitly stated otherwise, no AutoRound tuning is applied.**
...
|--------|------------|-------------|---------|---------------|----------|-------|-----------|----------------|------------|------|----------------|------------|------|
| f16 | f16 | 16 | 0.6326 | 0.5546 | 0.8333 | 0.8664 | 0.5717 | 0.6416 | 0.3140 | 0.7671 | 0.3672 | 0.6796 | 0.7301 |
...
| auto_round | 2.5b mixed[q2,q3,q4,q6] iters 200 | 3.25 | 0.6133 | 0.5060 | 0.8136 | 0.8541 | 0.5234 | 0.6565 | 0.3040 | 0.7606 | 0.3403 | 0.6827 | 0.6919 |
| unsloth | Q2_K_L | 3.34 | 0.6078 | 0.5128 | 0.8068 | 0.8529 | 0.5295 | 0.6276 | 0.3189 | 0.7546 | 0.3427 | 0.6567 | 0.6750 |
| bartowski | Q2_K_L | 3.79 | 0.6076 | 0.5162 | 0.8018 | 0.8449 | 0.5306 | 0.6266 | 0.3120 | 0.7606 | 0.3305 | 0.6717 | 0.6806 |
...
#### Evaluation with llama-server and EvalScope
...
| Qwen3.5-4B | Quant Type | Actual Bits | gpqa_diamond | math_500 |
|-------------|------------------------------------------------------|-------------|--------------|----------|
| f16 | f16 | 16 | 0.4697 | 0.79 |
| unsloth | UD-IQ2_M | 3.33 | 0.2273 | 0.594 |
| auto_round | 2.5 bits mixed[q2,q3,q4,q6] | 3.9 | 0.4242 | 0.72 |
| auto_round | 2.5 bits mixed[q2,q3,q4,q6] tuning iters 200 | 3.9 | 0.3838 | 0.754 |
| auto_round | Q3_K_M | 4.17 | 0.4042 | 0.772 |
| unsloth | Q3_K_M | 4.34 | 0.4040 | 0.776 |
| auto_round | 3.5 bits mixed[q2,q3,q4,q6] | 4.86 | 0.4192 | 0.804 |
| auto_round | 3.5 bits mixed[q2,q3,q4,q6] tuning iters 200 | 4.86 | 0.4192 | 0.786 |
| auto_round | Q4_K_M | 5.12 | 0.4545 | 0.792 |
| auto_round | Q4_K_M (repeat 5) | 5.12 | 0.4323 | 0.7958 |
| unsloth | Q4_K_M | 5.19 | 0.3838 | 0.794 |
| unsloth | Q4_K_M (repeat 5) | 5.19 | 0.4424 | 0.7906 |

| Gemma-4-12B-IT | Quant Type | Actual Bits | gpqa_diamond | math_500 |
|-----------------|------------------------------------------------------|-------------|--------------|----------|
| unsloth | Q3_K_M | 3.81 | 0.5253 | 0.886 |
| auto_round | 3.5 bits mixed[q2,q3,q4,q6] | 3.99 | 0.4545 | 0.818 |
| auto_round | 3.5 bits mixed[q2,q3,q4,q6] tuning iters 200 | 3.99 | 0.4949 | 0.87 |
| auto_round | Q3_K_M | 4.08 | 0.5354 | 0.874 |
| unsloth | Q4_K_M | 4.77 | 0.5758 | 0.912 |
| auto_round | Q4_K_M | 4.85 | 0.5808 | 0.9 |
