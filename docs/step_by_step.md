...
> Gray indicates the absence of a kernel or the presence of only an inefficient/reference kernel.

|export format | supported scheme |
|--------------|------------------|
|**auto_round**    | W4A16, W2A16, W3A16, W8A16, <span style="color:gray;">MXFP4</span>, <span style="color:gray;">MXFP8</span>, NVFP4, FPW8A16, W2A16G64, W2A16G32, <span style="color:gray;">FP8_STATIC</span>, BF16|
...
|**llm_compressor / auto_round:llm_compressor** | <span style="color:gray;">MXFP4</span>, <span style="color:gray;">MXFP8</span>, NVFP4, FPW8A16, <span style="color:gray;">FP8_STATIC</span> |
