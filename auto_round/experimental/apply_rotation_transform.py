...
* ``inplace``  – :mod:`auto_round.experimental.rotation_inplace`
...
from auto_round.experimental.utils import normalize_rotation_config
...
def apply_hadamard_rotation(
    ...
    if backend == "inplace":
        ...
        from auto_round.experimental.rotation_inplace import apply_rotation_transform
