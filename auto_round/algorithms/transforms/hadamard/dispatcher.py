...
* ``inplace``  – :mod:`auto_round.algorithms.transforms.hadamard.inplace`
...
* ``transform`` – :mod:`auto_round.algorithms.transforms.hadamard`
...
def apply_hadamard_rotation(
    ...
    if backend == "inplace":
        ...
        from auto_round.algorithms.transforms.hadamard.inplace import apply_rotation_transform
