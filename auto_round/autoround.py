...
class AutoRound:
    ...
    Attributes:
        ...
        enable_torch_compile (bool): Whether to enable torch.compile for quant blocks/layers. Defaults to True except
                         on Windows, where it defaults to False.
    """
        ...
        **kwargs,
        ...
        Args:
            ...
            enable_torch_compile (bool, optional): Enable torch.compile for low cost in quantization. Defaults to True
                                                  except on Windows, where it defaults to False. Pass True to force it.
