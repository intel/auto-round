...
class AutoRound(object):
    ...
    Args:
        ...
        use_quanted_input (bool): Whether to use the output of the previous quantized block as the input for the current
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.amp = amp
        self.use_quanted_input = use_quanted_input
        self.enable_minmax_tuning = enable_minmax_tuning
    ...
    def quant_block(self, block, input_ids, input_others, q_input=None, device=torch.device("cpu")):
        ...
        Returns:
        Tuple: (q_outputs, output) if self.use_quanted_input is True, else (None, output)
        """
    ...
    def save_quantized(self, output_dir=None, format="auto_gptq", inplace=True, **kwargs):
        ...
        compressed_model = save_quantized_as_format(
            ...
            use_quanted_input=self.use_quanted_input,
    ...
    def quantize(self):
        ...
        if len(layer_names) > 0:
            ...
            for layer_name in layer_names:
                q_layer_input = q_layer_inputs[layer_name] if self.use_quanted_input else None
...
class AutoOPTRound(AutoRound):
    ...
    Args:
        ...
        dataset_name (str): The default dataset name (default is "NeelNanda/pile-10k").
        dataset_split (str): The split of the dataset to be used (default is "train").
        use_quanted_input (bool): Whether to use quantized input data (default is True).
