...
_register_template("mimo_audio", default_dataset="audiocaps", processor=PROCESSORS["mimo_audio"])
_register_template("qwen3_tts", default_dataset="audiocaps", processor=PROCESSORS["qwen3_tts"])
