...
def set_layer_config(
    ...
    # 1. ignore -> force 16
    for name in get_fp_layer_names(model, ignore):
        layer_config[name] = {
            "bits": 16,
            "act_bits": 16,
            "data_type": "float",
...
def get_fp_layer_names(model: torch.nn.Module, ignore: str):
    ...
    Args:
        ...
        ignore (str): A comma-separated string of layer names to be excluded
