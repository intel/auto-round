...
* [2026/08] **现已实验性支持 FLUX.1-dev 的 SVDQuant。** AutoRound 支持将 SVDQuant 与 RTN 或 SignRound 结合，并可导出适配 Nunchaku 的 MXFP4 模型。查看[使用文档](./docs/svdquant_details_CN.md)和[示例模型](https://huggingface.co/changwangss/smooth_svdquant_signround)。
